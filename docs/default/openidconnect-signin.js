...
import "./node_modules/keycloak-js/dist/keycloak.js";
...
class OpenIDConnectSignIn extends LitElement {
  ...
  constructor() {
    ...
    window.addEventListener("logout", () => {
      ...
      dispatchEvent(new CustomEvent("signed-out", {
        bubbles: true
      }));
      ...
      this._keycloak.init({
        ...
        if (authenticated) {
          ...
          this._keycloak.loadUserInfo().then(() => {
            ...
            dispatchEvent(new CustomEvent("signed-in", {
              bubbles: true,
              detail: this._keycloak.userInfo
            }));
          });
